...
export default function MetricCard({ label, value, icon: Icon, accent }: MetricCardProps) {
  ...
  return (
    <div className="group relative flex h-full items-center justify-between overflow-hidden rounded-xl border border-border bg-card p-4 shadow-[var(--shadow-card)] transition-[transform,translate,box-shadow] duration-200 hover:-translate-y-1 hover:shadow-[var(--shadow-pop)]">
